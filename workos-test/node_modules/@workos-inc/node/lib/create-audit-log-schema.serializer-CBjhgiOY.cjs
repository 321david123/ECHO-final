...
//#endregion
Object.defineProperty(exports, 'deserializeAuditLogSchema', {
  enumerable: true,
  get: function () {
    return deserializeAuditLogSchema;
  }
});
//# sourceMappingURL=create-audit-log-schema.serializer-CBjhgiOY.cjs.map