//#region src/common/utils/env.d.ts
/**
 * Cross-runtime environment variable helper
 */
type Runtime = 'node' | 'deno' | 'bun' | 'cloudflare' | 'fastly' | 'edge-light' | 'other';
/**
 ...
 */
declare function getEnv<T = string>(key: string, defaultValue?: T): string | T | undefined;
//#endregion
export { detectRuntime, getEnv };
