import { HttpClientInterface, HttpClientResponseInterface, RequestHeaders, RequestOptions, ResponseHeaders } from "../interfaces/http-client.interface.js";
...
declare abstract class HttpClientResponse implements HttpClientResponseInterface {
  _statusCode: number;
...
declare class HttpClientError<T> extends Error {
...
//#endregion
export { HttpClient, HttpClientError, HttpClientResponse };
