import { HttpClientInterface, HttpClientResponseInterface, RequestOptions, ResponseHeaders } from "../interfaces/http-client.interface.js";
import { HttpClient, HttpClientResponse } from "./http-client.js";

//#region src/common/net/fetch-client.d.ts
...
declare class FetchHttpClient extends HttpClient implements HttpClientInterface {
  ...
  patch<Entity = any>(path: string, entity: Entity, options: RequestOptions): Promise<HttpClientResponseInterface>;
