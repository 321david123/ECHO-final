import { serializeAuthenticateWithCodeAndVerifierOptions } from "./authenticate-with-code-and-verifier-options.serializer.js";
...
import { deserializeAuthenticationResponse } from "./authentication-response.serializer.js";
import { serializeCreateMagicAuthOptions } from "./create-magic-auth-options.serializer.js";
import { serializeCreatePasswordResetOptions } from "./create-password-reset-options.serializer.js";
import { serializeCreateUserOptions } from "./create-user-options.serializer.js";
import { deserializeEmailVerification, deserializeEmailVerificationEvent } from "./email-verification.serializer.js";
import { serializeEnrollAuthFactorOptions } from "./enroll-auth-factor-options.serializer.js";
import { deserializeFactor, deserializeFactorWithSecrets } from "./factor.serializer.js";
import { deserializeInvitation, deserializeInvitationEvent } from "./invitation.serializer.js";
import { serializeListSessionsOptions } from "./list-sessions-options.serializer.js";
import { deserializeMagicAuth, deserializeMagicAuthEvent } from "./magic-auth.serializer.js";
import { deserializePasswordReset, deserializePasswordResetEvent } from "./password-reset.serializer.js";
import { serializeResetPasswordOptions } from "./reset-password-options.serializer.js";
